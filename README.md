...
mkdir aws-projects
cd aws-projects/
git clone git@github.com:safayavatsal/Grafana_and_Prometheus_MERN_app.git
cd Grafana_and_Prometheus_MERN_app/
git clone git@github.com:safayavatsal/TravelMemory.git
cd backend/
touch .env
